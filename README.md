...
#define ldr_pin 34
char ssid[] = "VivoY285G";   // your network SSID (name) 
char pass[] = "12348765";   // your network password
int keyIndex = 0;            // your network key Index number (needed only for WEP)
WiFiClient  client;

unsigned long myChannelNumber =  2755083;
const int ChannelField = 1;
const char * myWriteAPIKey = "V2EGT8QIIS5GRR61";
